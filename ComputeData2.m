function [J, G, J1, J2, J3, G1, G2, G3, u, Theta, dataEigen] = ComputeData2(phi,TriInfo,Transformation,matrices,constants,material,computeG,dataEigen)
    ...
    regThetaL1 = constants.regThetaL1;
    regPhiL1   = constants.regPhiL1;
    regPhiL2   = constants.regPhiL2;
    ...
    if nargout > 1 && computeG
        ...
        B     = [B11 B12; B21 B22];
        bAdjQ = -M1*(Theta-TriInfo.phiGe) + regThetaL1*-M1*ones(npoint,1);
        bAdjQ = [bAdjQ(id1D); 0]; % Add zero for the eigenvalue
