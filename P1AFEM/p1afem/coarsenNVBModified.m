function [coordinates,elements,dataReduce,varargout] = coarsenNVBModified(N0,coordinates,elements,dataReduce,varargin) 
...
%Comments:
%
%    coarsenNVB expects as input a finite element mesh described by the fields 
...
%    possible).
%
%    Please see <example2.m> for an example on the use of this function.
%
%Remark:
%
...
if ~isempty(dataReduce)
    dataReduce  = dataReduce(activeNodes,:);
end
