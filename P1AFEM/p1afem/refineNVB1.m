function [coordinates,newElements,varargout] ...
           = refineNVB1(coordinates,elements,varargin)

%refineNVB1: local refinement of finite element mesh by newest vertex
%           bisection, where marked elements are refined by one bisection
%
%Usage:
%
...
%Comments:
%
%    refineNVB1 expects as input a finite element mesh described by the 
%    fields coordinates,elements,dirichlet and neumann. The vector 
%    marked contains the indices of elements which are refined by one bisection.
